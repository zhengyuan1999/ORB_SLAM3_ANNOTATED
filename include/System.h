...
public:
    /**
     * @brief 静态成员函数，根据预设规则向标准输出打印内容（欲打印消息小于等于系统设定的等级）
     * 
     * @param[in] str 欲打印消息
     * @param[in] lev 本信息等级
    */
    ...
    /**
     * @brief 静态成员函数，设置通知等级（只在 System 构造函数中被调用一次）
     * 
     * @param[in] _th 通知等级
    */
...
public:
    ...
    */
    ...
    // Map 已经被 Atlas 所取代，正好 ORB-SLAM2 作者也没写
