...
// Step2. Read first camera
    readCamera1(fSettings);
    cout << "\t-Loaded camera 1" << endl;


// Step3. Read second camera if stereo (not rectified)
...
// Step2. Read intrinsic parameters
...
// Step3. Check if it is a distorted PinHole
...
void Settings::precomputeRectificationMaps()
{
    ...
    cv::stereoRectify(K1, camera1DistortionCoef(), K2, camera2DistortionCoef(), newImSize_,
            R12, t12, R_r1_u1, R_r2_u2, P1, P2, Q, cv::CALIB_ZERO_DISPARITY, -1, newImSize_);
